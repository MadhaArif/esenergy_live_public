...
const About = () => {
  return (
    <div className="about-page">
      ...
      {/* 5. The EN Energy Advantage */}
      <section style={{ backgroundColor: 'var(--bg-secondary)' }}>
        <div className="container">
          <div style={{ textAlign: 'center', marginBottom: '50px' }}>
            <span className="featured-tag">BENEFITS</span>
            <h2 style={{ fontSize: '32px', fontWeight: '800', marginTop: '12px', color: 'var(--text-primary)' }}>The EN Energy Advantage</h2>
        ...
        <div className="container">
          ...
          <ScrollReveal delay={100} style={{ maxWidth: '720px', margin: '0 auto', backgroundColor: '#ffffff', border: '1px solid rgba(15, 23, 42, 0.05)', borderRadius: '8px', padding: '40px', textAlign: 'center' }}>
            ...
            <p style={{ fontSize: '14px', lineHeight: '1.7', color: 'var(--text-secondary)', margin: 0 }}>
              Every solar system integrated by EN Energy is evaluated against local grid code standards and utility coordination checklists. We coordinate connection permits, verify safety requirements, and plan earthing protection grids in compliance with Pakistan utility standards.
            </p>
          </ScrollReveal>
        </div>
      </section>
