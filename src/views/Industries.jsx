      ...
      <section id="residential">
        <div className="container">
          ...
          <ScrollReveal delay={100} className="industry-consultation-banner">
            ...
            <Button to="/contact?sector=residential#contact-form" variant="primary">Request Home Feasibility Study</Button>
          </ScrollReveal>
        </div>
      </section>
      ...
      <section id="commercial" style={{ backgroundColor: 'var(--bg-primary)' }}>
        <div className="container">
          ...
          <ScrollReveal delay={100} className="industry-consultation-banner">
            ...
            <Button to="/contact?sector=commercial#contact-form" variant="primary">Request Commercial Consultation</Button>
          </ScrollReveal>
        </div>
      </section>
      ...
      <section id="industrial">
        <div className="container">
          ...
          <ScrollReveal delay={100} className="industry-consultation-banner">
            ...
            <Button to="/contact?sector=industrial#contact-form" variant="primary">Schedule Industrial Plant Audit</Button>
          </ScrollReveal>
        </div>
      </section>
    </div>
