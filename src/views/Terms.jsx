      ...
      <section>
        <div className="container">
          <div style={{ maxWidth: '800px', margin: '0 auto', color: 'var(--text-secondary)', lineHeight: '1.7' }}>
            ...
            <p>
              The visual layouts, custom SVG blueprints, single-line schematics, content copy, and logos on this website are the proprietary property of ES Energy and are protected under copyright and trademark laws.
            </p>

            <h3 style={{ color: 'var(--text-primary)', marginTop: '30px', marginBottom: '12px' }}>4. Disclaimer</h3>
            <p>
              The materials on this website are provided on an 'as is' basis. ES Energy makes no warranties, expressed or implied, and hereby disclaims all other warranties including, without limitation, implied warranties of merchantability or fitness for a particular purpose.
            </p>
          </div>
        </div>
      </section>
