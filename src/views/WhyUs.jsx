    ...
    <div className="why-us-page">
      ...
      <div className="page-hero">
        <div className="container">
          ...
          <span className="final-cta-eyebrow" style={{ color: 'var(--accent-gold)' }}>WHY ES ENERGY</span>
          ...
          <p style={{ maxWidth: '720px', margin: '0 auto 32px auto' }}>
            ES Energy approaches every solar project as an engineered energy system. We evaluate consumption, site conditions, equipment compatibility, backup requirements, and long-term operating needs before recommending a solution.
          </p>
          <div style={{ display: 'flex', gap: '16px', justifyContent: 'center', flexWrap: 'wrap' }}>
            <Button to="/contact#contact-form" variant="primary">Start Your Feasibility Review</Button>
            <Button to="/solutions" variant="outline">Explore Our Solutions</Button>
          </div>
        </div>
      </div>

      {/* SECTION 2 — WHY CHOOSE ES ENERGY */}
      <section className="why-choose-us-section" style={{ backgroundColor: '#ffffff' }}>
        <div className="container">
          <div style={{ textAlign: 'center', maxWidth: '640px', margin: '0 auto 60px auto' }}>
            ...
            <h2 style={{ fontSize: '32px', fontWeight: '800', marginTop: '12px', color: 'var(--text-primary)' }}>Why Choose ES Energy</h2>
        ...
        <div className="container">
          ...
          <ScrollReveal delay={100} className="sectors-serve-grid">
            <div className="sector-serve-card">
              ...
              <Link href="/solutions?sector=residential" className="sector-card-link">
            ...
            <div className="sector-serve-card">
              ...
              <Link href="/solutions?sector=commercial" className="sector-card-link">
            ...
            <div className="sector-serve-card">
              ...
              <Link href="/solutions?sector=industrial" className="sector-card-link">
      ...
      <section className="final-cta-section">
        ...
        <div className="container final-cta-container">
          ...
          <div className="final-cta-buttons">
            <Link href="/contact#contact-form" className="final-cta-btn-primary">
              <span>Book a Feasibility Study</span>
              <span className="cta-btn-arrow">→</span>
            </Link>
            <Link href="/contact?type=consultation#contact-form" className="final-cta-btn-secondary">
